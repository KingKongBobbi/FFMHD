...
class BaseDataset(Dataset):
    ...
    def _load_image(self, index: int) -> torch.Tensor:
        if not self.npy:
            #image_path = "/home/wangg/DataSet/COCO/train2017/"+self.indexs[index].strip().split("/")[-1]
        ...
        # image = self.transform(image)
            if(image_path[11:18]=="nuswide"):
                image_path = "/home/lihan/DataSet/"+image_path[11:]
            elif(image_path[11:18]=="COCO"):
                image_path = "/home/lihan/DataSet/"+image_path[11:]
            else :
                image_path=image_path[:6]+"lihan/DataSet"+image_path[39:]
            # else :
            #     image_path=image_path[:6]+"lihan"+image_path[11:]
